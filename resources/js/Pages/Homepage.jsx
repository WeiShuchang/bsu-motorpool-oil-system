                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                ...
                                <div className="flex flex-wrap gap-4 pt-4">
                                    ...
                                    <Link
                                        href="#features"
                                        className="inline-flex items-center justify-center gap-2 border border-green-200 bg-white hover:bg-green-50 text-gray-700 font-medium h-12 px-8 rounded-md text-lg transition-colors"
                                    >
                                        Learn More
                                    </Link>
                                </div>
                            ...
                            <div className="relative">
                                <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                                    <img 
                                        src="https://images.unsplash.com/photo-1762604462421-fff920b0c418?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxvaWwlMjBjaGFuZ2UlMjBtYWludGVuYW5jZSUyMG1lY2hhbmljfGVufDF8fHx8MTc3MDk3OTAxNXww&ixlib=rb-4.1.0&q=80&w=1080" 
                                ...
                                {/* Floating Cards */}
                                <div className="absolute -left-4 top-1/4 bg-white p-4 rounded-xl shadow-lg border border-green-100">
                                    <div className="text-3xl font-bold text-green-600">24/7</div>
                                    <div className="text-sm text-gray-500">Monitoring</div>
                                </div>
                                <div className="absolute -right-4 bottom-1/4 bg-white p-4 rounded-xl shadow-lg border border-green-100">
